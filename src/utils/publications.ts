...
export function normalizePublicationData(publication: unknown): PublicationData {
  return {
    id: String((publication as Record<string, unknown>)?._id || (publication as Record<string, unknown>)?.id || ''),
    title: String((publication as Record<string, unknown>)?.title || 'Sin título'),
    description: String((publication as Record<string, unknown>)?.description || ''),
    categorySlug: String((publication as Record<string, unknown>)?.categorySlug || (publication as Record<string, unknown>)?.category || 'general'),
    subcategorySlug: String((publication as Record<string, unknown>)?.subcategorySlug || (publication as Record<string, unknown>)?.subcategory || '') || null,
    subSubcategorySlug: String((publication as Record<string, unknown>)?.subSubcategorySlug || (publication as Record<string, unknown>)?.subsubcategory || '') || null,
    transactionType: String((publication as Record<string, unknown>)?.transactionType || 'venta'),
    value: Number((publication as Record<string, unknown>)?.value || (publication as Record<string, unknown>)?.price || (publication as Record<string, unknown>)?.amount || 0),
    currency: String((publication as Record<string, unknown>)?.currency || 'PEN'),
    valueType: String((publication as Record<string, unknown>)?.valueType || 'fixed'),
    ...
    premium: Boolean((publication as Record<string, unknown>)?.premium || false),
  };
}
