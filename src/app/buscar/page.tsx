...
function SearchPageContent({ publicationsData, results, setResults, isLoading, setIsLoading, totalCount, setTotalCount, hasSearched, setHasSearched }: {
  ...
  }, [selectedCategory, selectedSubcategory, selectedSubSubcategory, hasSearched, sortBy, lastSearchCategory, currentQuery, setIsLoading, setResults, setTotalCount])
        ...
        />
                ...
                {isSidebarOpen && selectedPublication && (
                  <div className="hidden lg:block lg:w-1/2 lg:flex-shrink-0">
                    <div className="sticky-sidebar sticky-container h-fit max-h-[calc(100vh-120px)] overflow-y-auto smooth-scroll bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
