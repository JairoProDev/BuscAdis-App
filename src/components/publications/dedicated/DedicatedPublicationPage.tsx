...
export default function DedicatedPublicationPage({
  ...
  return (
    <>
      {/* SEO Head */}
      <Head>
        <title>{publication.title} | BuscAdis</title>
              ...
              <div className="sticky top-24">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg mb-6">
                  ...
                  <button
                    ...
                    className={`w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-4 rounded-xl transition-colors mb-3 flex items-center justify-center gap-2`}
                  >
                  ...
                  <div className="space-y-2">
                    <button className="w-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-900 dark:text-white font-medium py-2 px-4 rounded-lg transition-colors flex items-center justify-center gap-2">
                      <ChatBubbleLeftRightIcon className="w-4 h-4" />
                      {categoryConfig.secondaryAction}
                    </button>
                    <button className="w-full bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/30 text-red-600 dark:text-red-400 font-medium py-2 px-4 rounded-lg transition-colors">
                      Reportar Anuncio
                    </button>
                  </div>
                </div>
